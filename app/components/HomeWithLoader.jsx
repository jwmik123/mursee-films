...
export default function HomeWithLoader({ films }) {
  ...
  return (
    <div className="relative">
      <div id="awwwards" style={{position: 'fixed', zIndex: 999, transform: 'translateY(-50%)', top: '50%', left: 0}}>
        <Link href="https://www.awwwards.com/sites/mursee-films" target="_blank">
